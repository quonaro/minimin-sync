    ...
    <main class="flex-1 p-6 flex flex-col">
          ...
          <div v-else class="flex flex-col gap-4">
            <div>
              <label class="block text-sm text-neutral-400 mb-1"
                >Check interval (minutes, 0 = disabled)</label
              >
              <input
      ...
      >
        <div class="flex justify-center mb-4">
          <div
            class="inline-flex items-center gap-2 p-1 rounded-lg bg-[#262626] border border-neutral-700"
          >
            <button
      ...
      >
        <div
          class="max-w-sm w-full p-6 rounded-xl bg-[#262626] border border-neutral-700"
        >
          <h3 class="text-lg font-bold mb-2">Link Build</h3>
          <p class="text-neutral-400 text-sm mb-4">
            Link <span class="text-white font-medium">{{ linkTarget }}</span>
            to a MiniMin archive URL without changing its files.
          </p>
          <input
            v-model="linkUrl"
            type="text"
